...
class EvalFrameworkTests(TestCase):
    ...
    def setUpClass(self):
        ...
        _mock_result_table1 = '\n'.join([',Dataset,F-measure,Method,Parameters,Pearson p,Pearson r,Precision,Recall,Reference,SampleID,Spearman p,Spearman r,best N alignments,confidence,coverage,e value,e-value,max accepts,min consensus fraction,similarity',
